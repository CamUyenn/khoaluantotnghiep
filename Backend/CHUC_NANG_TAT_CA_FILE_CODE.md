...
| `Frontend/src/features/cashier/components/*`                                                                                  | Đơn thuốc đang chờ xử lý, đơn thuốc đã cấp phát, hộp thoại thanh toán, thống kê nhà thuốc.                                                                                                            |
| `Frontend/src/features/admin/components/*`                                                                                    | Quản lý người dùng, quản lý phòng, quản lý thuốc, quản lý dịch vụ, quản lý cài đặt, báo cáo, quản lý mẫu chẩn đoán, quản lý loại bệnh, quản lý triệu chứng. |
